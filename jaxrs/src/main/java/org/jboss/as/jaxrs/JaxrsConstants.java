...
public class JaxrsConstants {
    ...
    public static final String RESTEASY_PREFERJACKSONOVERJSONB = "resteasy-preferJacksonOverJsonB";
    ...
    static {
        ...
        nameToAttributeMap.put(RESTEASY_PREFERJACKSONOVERJSONB, JaxrsAttribute.RESTEASY_PREFERJACKSONOVERJSONB);
        nameToAttributeMap.put(RESTEASY_PROVIDERS, JaxrsAttribute.RESTEASY_PROVIDERS);
        nameToAttributeMap.put(RESTEASY_RESOURCES, JaxrsAttribute.RESTEASY_RESOURCES);
