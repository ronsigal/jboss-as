...
public class JaxrsServerConfig {
    ...
    private ModelNode resteasyResources;
    ...
    public ModelNode getResteasyResources() {
        return resteasyResources;
    }
    public void setResteasyResources(ModelNode resteasyResources) {
        this.resteasyResources = resteasyResources;
    }
